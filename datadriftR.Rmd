...
Additional details on batch sizes (Table~\ref{tab:batch_number}), key variables (Table~\ref{tab:vip_batch}) and model accuracy (Table~\ref{tab:acc_batch}) are provided in supplemantal materials section.
