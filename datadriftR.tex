...
Additional details on batch sizes (Table\textasciitilde{}\ref{tab:batch_number}), key variables (Table\textasciitilde{}\ref{tab:vip_batch}) and model accuracy (Table\textasciitilde{}\ref{tab:acc_batch}) are provided end of the paper.
